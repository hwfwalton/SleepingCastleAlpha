...
enum CLUE_SYMBOL {
	...
	LIGHTNING_BOLT, LUTE, MOON, RAIN, RED_HORSE, ROSE_DEPRECATED, ROSE_SIGIL, RUBY,
...
var clue_symbol_display_text = {
	...
	CLUE_SYMBOL.ROSE_DEPRECATED: "Rose DEPRECATED",
...
var clue_symbol_sort_values = {
	...
	CLUE_SYMBOL.ROSE_DEPRECATED: "Rose DONT USE",
